"""
Django settings for interclass project.
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            ...
            "symmetric_encryption_keys": [os.getenv('REDIS_SECRET_KEY')]
        }
    }
}
...
# WSGI_APPLICATION = 'interclass.wsgi.application'

ASGI_APPLICATION = 'interclass.asgi.application'
